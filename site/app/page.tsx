...
const downloadUrl = `${releaseBaseUrl}/usAIge-0.2.10-alpha.dmg`;
const checksumUrl = `${releaseBaseUrl}/usAIge-0.2.10-alpha.dmg.sha256`;
    ...
    <main>
      ...
      <section className="hero shell" id="top">
        <div className="hero__copy">
          <p className="eyebrow"><span /> v0.2.10 · Native macOS utility</p>
          ...
          <div className="hero__actions">
            <a className="button button--primary" href={downloadUrl} download>
              ...
              <span><strong>Download for macOS</strong><small>v0.2.10 alpha · macOS 11+ · Apple silicon</small></span>
            </a>
      ...
      <section className="install shell" id="install">
        ...
        <div className="install__cta">
          <a className="button button--primary" href={downloadUrl} download>
            <span className="button__icon" aria-hidden="true">↓</span>
            <span><strong>Download usAIge</strong><small>v0.2.10 alpha · macOS 11 or later · Apple silicon</small></span>
          </a>
      ...
      <footer className="footer shell">
        ...
        <span>v0.2.10 public alpha · 2026</span>
      </footer>
    </main>
  );
}
