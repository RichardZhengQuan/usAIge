...
enum UsagePalette {
    static func primary(remainingPercent: Double) -> Color {
        severityColor(remainingPercent: remainingPercent, normal: .cyan)
    }

    static func secondary(remainingPercent: Double) -> Color {
        severityColor(remainingPercent: remainingPercent, normal: .purple)
    }

    static func severityColor(remainingPercent: Double, normal: Color) -> Color {
